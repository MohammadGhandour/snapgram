            ...
            <div className="profile-inner_container">
                <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
                    <img
                        ...
                        alt="profile"
                        className="w-28 h-28 lg:w-36 lg:h-3/6 rounded-full bg-white object-cover"
                    />
                    <div className="flex flex-col flex-1 justify-between md:mt-2">
                        ...
                        <p className="small-medium md:base-medium text-center xl:text-left mt-7 max-w-screen-sm whitespace-pre-line">{currentUser.bio}</p>
                    </div>
